...
int CHttpClient::HttpPostWithNoCer(LPCTSTR strUrl, LPCTSTR strHeader, LPCTSTR strPostData, CString &strResponse)
{
	CString strServer;
	CString strObject;
	DWORD dwServiceType;
